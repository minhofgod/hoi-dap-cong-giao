...
export const ERA_BLURB: Record<Era, Bi> = {
  ...
  modern: {
    vi: 'Ba công đồng định hình Hội Thánh hiện đại: Trentô đáp lại cuộc Cải Cách, Vaticanô I về quyền tối thượng, và Vaticanô II về Hội Thánh giữa thế giới hôm nay.',
